...
export function * getColumn(column: number, cells: Array<Cell>, start: number = 0, end: number = 8): IterableIterator<Cell> {
    for (const row of array.iterator.range(start, end, 1)) {
